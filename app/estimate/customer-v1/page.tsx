...
import { formatServicePrice } from "@/lib/estimate-pricing-v1"
import {
  Clock,
  User,
  Mail,
...
const availableServices = [
  ...
  { id: "tv-xl", name: "TV Installation (76\" and larger)", basePrice: 400, category: "installation", pricingType: "flat" },
...
export default function CustomerPage() {
  ...
  useEffect(() => {
    ...
    if (!storedData) {
      router.push("/estimate/services-v1")
      return
    }
  ...
  const handleNext = () => {
    if (isFormComplete) {
      ...
      router.push("/estimate/confirmation-v1")
    }
  }
      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-center mt-8">
            <Button
              variant="outline"
              onClick={() => router.push("/estimate/services-v1")}
              className="gap-2"
            >
