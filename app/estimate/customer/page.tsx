...
const availableServices = [
  ...
  { id: "ceiling-fan", name: "Ceiling Fan Installation", basePrice: 175, category: "installation", pricingType: "flat" },
  { id: "tv-small", name: "TV Installation (74\" and smaller)", basePrice: 200, category: "installation", pricingType: "flat" },
  { id: "tv-large", name: "TV Installation (75\" and larger)", basePrice: 275, category: "installation", pricingType: "flat" },
  { id: "tv-soundbar", name: "Soundbar Mount & Subwoofer", basePrice: 75, category: "installation", pricingType: "flat" },
  ...
  { id: "audio-system", name: "Audio System Installation (hourly)", basePrice: 150, category: "installation", pricingType: "flat" },
  { id: "doorbell", name: "Smart Doorbell Installation", basePrice: 150, category: "installation", pricingType: "flat" },
  { id: "single-camera", name: "Camera Installation (hourly)", basePrice: 150, category: "installation", pricingType: "flat" },
  ...
  { id: "smart-switch", name: "Smart Switch / Dimmer / Outlet Installation", basePrice: 150, category: "electrical", pricingType: "flat" },
  { id: "picture-hanging", name: "Picture & Art Hanging (hourly)", basePrice: 150, category: "installation", pricingType: "flat" },
  { id: "picture-hanging-item", name: "Picture & Art Hanging (per item)", basePrice: 45, category: "installation", pricingType: "flat" },
  ...
  { id: "garage-hex-1car", name: "Garage Hex Lighting (1-car)", basePrice: 750, category: "lighting", pricingType: "flat" },
  ...
  { id: "permanent-led-s", name: "Permanent LED Lighting (S · ~50 ft)", basePrice: 1500, category: "lighting", pricingType: "flat" },
  { id: "permanent-led-m", name: "Permanent LED Lighting (M · ~100 ft)", basePrice: 3000, category: "lighting", pricingType: "flat" },
  { id: "permanent-led-l", name: "Permanent LED Lighting (L · ~150 ft)", basePrice: 4500, category: "lighting", pricingType: "flat" },
  { id: "permanent-led-xl", name: "Permanent LED Lighting (XL · ~200 ft)", basePrice: 6000, category: "lighting", pricingType: "flat" },
              ...
              <Card className="lg:sticky lg:top-24">
                ...
                <CardContent className="space-y-4 pt-4">
                  ...
                  {(() => {
                    ...
                    const ladderIdList: string[] = estimateData?.services?.ladderFeeServices || []
                    const ladderFee = ladderIdList.length > 0 ? 400 : 0
                    const totalEstimate =
                    ...
                    return (
                      <>
                        ...
                        <div className="flex items-center justify-between font-semibold">
                          ...
                          <span className="text-base">${totalEstimate.toLocaleString("en-US")}</span>
                        </div>
